@if (! $currentProject)
    ...
    <section class="panel sintak-setup-panel">
        <div class="panel-header">
            <div>
                <h2 class="panel-title">Mulai Proyek dari Sintaks BADRUL</h2>
                <p class="panel-subtitle">Pilih pertemuan terlebih dahulu. Materi akan menyesuaikan otomatis, lalu proyek dibuat saat Anda menekan tombol mulai.</p>
            </div>
        </div>
